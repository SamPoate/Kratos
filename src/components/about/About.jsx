    ...
    <div id='about'>
      ...
      <ol>
        <li>
          ...
          are committed to safeguarding it. This policy explains what we will do
      ...
      <p>
        <strong>C. Collecting personal information</strong>
      </p>
      <p>
      ...
      <ol>
        ...
        <li>
          ...
          publishing it on the internet, which includes your username, profile
      ...
      <p>
        <strong>D. Using your personal information</strong>
      </p>
      <p>
      ...
      <ol>
        ...
        <li>
          sending you marketing communications relating to our business or the
      ...
      <p>
        <strong>E. Disclosing personal information</strong>
      </p>
      <p>
        ...
        subcontractors as reasonably necessary for the purposes set out in this
        policy.
      </p>
      <p>
        ...
        all its subsidiaries) as reasonably necessary for the purposes set out
        in this policy.
      </p>
      ...
      <p>
        <strong>F. International data transfers</strong>
      </p>
      <ol>
        <li>
      ...
      <p>
        <strong>G. Retaining personal information</strong>
      </p>
      <ol>
        <li>
        ...
        <li>
          Without prejudice to article G-2, we will usually delete personal data
          falling within the categories set out below at the date/time set out
          below:
          <ol type='a'>
            <li>personal data type will be deleted within one month; and</li>
          </ol>
        </li>
        <li>
      ...
      <p>
        <strong>H. Security of your personal information</strong>
      </p>
      <ol>
        <li>
      ...
      <p>
        ...
        this policy by email or through the private messaging system on our
        website.
      </p>
      <p>
      ...
      <p>
        ...
        about you; provision of such information will be subject to the
        following:
      </p>
      <ol>
        <li>the payment of a fee N/A; and</li>
        <li>
          the supply of appropriate evidence of your identity (we will usually
          accept a photocopy of your passport certified by a notary plus an
      ...
      <p>
        <strong>K. Third party websites</strong>
      </p>
      <p>
      ...
      <p>
        ...
        user session, when the web browser is closed. Cookies do not typically
        ...
        stored in and obtained from cookies. We use both session and persistent
      ...
      <ol>
        <li>
          ...
          <ol type='a'>
            <li>
              we use Google Analytics and Adwords on our website to recognize a
              ...
              security of the website / personalize the website for each user /
              target advertisements which may be of particular interest to
